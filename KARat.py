...
if (".exe" not in file_name) and (not file_name == ""):
    file_name += ".exe"
...
try:
    if file_name == "" and (not added_file_name == "" or not file_path == ""):
        subprocess.run(["pyinstaller", "socket_file.py", "--onefile", "--add-data", "\"{}.\"".format(file_path), "--windowed"],stdout=subprocess.DEVNULL)
    elif file_name == "":
        subprocess.run(["pyinstaller", "socket_file.py", "--onefile", "--windowed"], stdout=subprocess.DEVNULL)
    else:
        subprocess.run(["pyinstaller", "socket_file.py", "-n", file_name, "--onefile", "--windowed"], stdout=subprocess.DEVNULL)
